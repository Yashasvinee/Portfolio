...
// import { Award, Cloud, Shield, Database, Code, ExternalLink } from 'lucide-react';
...
//     //   skills: ["Application Development", "Deployment", "Debugging", "Monitoring"]
//     // },
//     // {
...
//     //   skills: ["Database Design", "Performance Tuning", "Migration", "Backup & Recovery"]
//     // }
//   ];
...
//             className="text-3xl font-bold text-gray-800 mb-8 flex items-center"
//           >
//             <Award className="mr-3 text-gold-500" size={32} />
...
//                 whileHover={{ scale: 1.02 }}
//                 className="bg-white border-2 border-gray-200 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300"
//               >
//                 <div className={`h-2 bg-gradient-to-r ${cert.color} rounded-full mb-4`}></div>
//                 <h4 className="text-xl font-bold text-gray-800 mb-2">
//                   {cert.title}
//                 </h4>
...
//                 whileHover={{ scale: 1.05 }}
//                 whileTap={{ scale: 0.95 }}
//                 className="border-2 border-white text-white px-8 py-3 rounded-full font-semibold hover:bg-white hover:text-blue-600 transition-colors duration-300 inline-flex items-center justify-center"
//               >
